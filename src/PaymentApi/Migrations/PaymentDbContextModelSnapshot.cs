...
partial class PaymentDbContextModelSnapshot : ModelSnapshot
{
    protected override void BuildModel(ModelBuilder b)
    {
        ...
        b.Entity("PaymentApi.TransactionEntity", e => { e.Property<long>("TransactionId").ValueGeneratedNever(); e.Property<decimal>("Amount").HasPrecision(12,2); e.Property<string>("CaseNo").IsRequired(); e.Property<string>("OriginalPaymentReference"); e.Property<string>("PaymentReference").IsRequired(); e.Property<DateTimeOffset>("TransactionDate"); e.Property<string>("TransactionMethod").IsRequired(); e.Property<string>("TransactionStatus").IsRequired(); e.Property<string>("TransactionType").IsRequired(); e.HasKey("TransactionId"); e.ToTable("Transactions"); });
