# HMCTS compatibility notes

The implementation target is `hmcts/ccpay-payment-app`: the service-request and
...
Material deliberate differences are: HMCTS's external payment provider is
